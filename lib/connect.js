 ...
 * Setzt nicht-überlappende, getrennt liegende Formen voraus — bei Überlappung
 * oder exakt aufeinanderliegenden zugewandten Kanten entsteht ein entarteter
 * Pfeil der Länge 0 (checkArrowBindings meldet das als Warnung "pfeilentartet").
 */
export function arrowElement({ a, b, ordnung, seite = null }) {
  ...
  return {
    ...
    opacity: 100,
    groupIds: [],
    // Pfeile sind absichtlich frame-los: sonst würde checkGeometrys
    // Frame-Grenzen-Prüfung den Pfeil an einer verbundenen Kante fälschlich
    // als "ragt über den Frame hinaus" melden oder ihn beschneiden.
    frameId: null,
