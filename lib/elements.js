...
export function lineElement({ punkte, rolle = "kontext", geschlossen = false, strichbreite, fuellung, ordnung }) {
  ...
  // Der fuellung-Teil wird NUR bei gesetzter Füllung angehängt — sonst änderte
  // sich die id (und damit seed/Rendering) jeder bestehenden ungefüllten Linie,
  // was die Golden-PNGs bräche. Gefüllte Linien bekommen so eine distinkte id.
