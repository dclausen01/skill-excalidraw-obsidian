...
/**
 * Strichfarbe für Frame-Rahmen. Frames sind Chrome (Navigations-/Gliederungsrahmen),
 * keine der sieben inhaltlichen Farbrollen aus FARBROLLEN — deshalb ein eigenes
 * Token statt eines Eintrags dort (Fix-Durchgang 1, Review-Finding 3).
 */
export const FRAME_STRICH = "#bbb";
