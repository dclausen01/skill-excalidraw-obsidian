...
import { checkSchema, checkReferences, checkTextIndex, checkArrowBindings, checkNoteLinks, checkImageRefs, detectOutOfScope } from "./structure.js";
...
export function validateScene(elemente, { markdown = null, registry = loadFontRegistry(), zoomL0 = 1, vaultPath = VAULT_PATH } = {}) {
  ...
  if (markdown !== null) {
    ...
    // Bild-Referenzen: braucht das Markdown (## Embedded Files), genau wie der
    // Textindex — ohne markdown lässt sich weder das eine noch das andere prüfen.
    checkImageRefs(elemente, markdown, befunde, { vaultPath });
  }
